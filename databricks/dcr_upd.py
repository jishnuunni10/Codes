...
# ------------------ Configuration ------------------
TENANT_URL = "https://mpe-01.reltio.com/reltio/api/<TENANT_ID>"
WORKFLOW_TASK_URL = "https://eu-test-workflow.reltio.com/workflow-adapter/workflow/<TENANT_ID>/tasks"
...
def get_access_token():
    ...
    headers = {
        'Authorization': 'Basic <YOUR_BASE64_CREDENTIALS>'  # Replace with your credentials
    }
